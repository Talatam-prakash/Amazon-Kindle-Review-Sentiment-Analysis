...
with open('vectorizer_word2vec.pkl', 'rb') as f:
    vectorizer_word2vec = pickle.load(f)
...
method = st.selectbox("Choose a vectorization method:", ['Bag of Words', 'TF-IDF', 'Word2Vec'])
